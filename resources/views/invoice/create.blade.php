...
<script type="text/javascript" src="../js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
	    ...
	    <h2 class="sub-header">Add invoice</h2>
	    <div class="pull-right" style="margin-top:20px;">			
		    <a href="{{ url('/invoice/list') }}" class="btn_back_onlystyle">Back</a>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control" name="invoice_no" value="{{ old('invoice_no') }}" readonly id="INV_no">
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control form_date" id="invoice_date" name="invoice_date" value="{{ date('Y-m-d') }}" data-format="yyyy-MM-dd" readonly >
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<textarea class="form-control summernote" name="invoice_description" rows="20">{{ old('invoice_description') }}</textarea>
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<textarea class="form-control summernote" name="invoice_remark" rows="10">{{ old('invoice_remark') }}</textarea>
