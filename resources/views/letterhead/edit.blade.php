...
<script type="text/javascript" src="../../js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
	     ...
	     <h2 class="sub-header">Edit letterhead</h2>
	   <div class="pull-right" style="margin-top:20px;">			
		...
		@endif
              <form class="form-horizontal" role="form" method="POST" action="{{ url('/letterhead/edit') }}">
                        {!! csrf_field() !!}
		<input type="hidden" name="letterhead_id" id="letterhead_id" value="{{ $letterhead->id }}" />
		<input type="hidden" name="id" value="{{ $letterhead->id }}"/>
		<div class="form-group">
		    <label class="col-md-4 control-label">Letterhead No<span class="add_redcolor">*</span></label>
		    <div class="col-md-4">
			<input type="text" class="form-control" name="letterhead_no" value="{{ $letterhead->letterhead_no }}" readonly id="LET_no">
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control" name="letterhead_subject" value="{{ $letterhead->letterhead_subject }}">
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control form_date" id="letterhead_date" name="letterhead_date" value="{{ $letterhead->letterhead_date }}" data-format="yyyy-MM-dd" readonly >
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<textarea class="form-control summernote" name="letterhead_description" rows="20">{{ $letterhead->letterhead_description }}</textarea>
