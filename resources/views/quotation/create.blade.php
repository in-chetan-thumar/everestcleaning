...
<script type="text/javascript" src="../js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
	    ...
	    <h2 class="sub-header">Add quotation</h2>
	    <div class="pull-right" style="margin-top:20px;">			
		    <a href="{{ url('/quotation/list') }}" class="btn_back_onlystyle">Back</a>
		</div>
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/quotation/save') }}">
        {!! csrf_field() !!}
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control" name="quotation_no" value="{{ old('quotation_no') }}" readonly id="QUO_no">
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<input type="text" class="form-control form_date" id="quotation_date" name="quotation_date" value="{{ date('Y-m-d') }}" data-format="yyyy-MM-dd" readonly >
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
				<select class="form-control" name="project_id" id="QUO_project_id">
				    ...
				    <option class="<?php echo $value->client_id; ?>" id="<?php echo $value->project_shortname_for_invoice; ?>" value="<?php echo $value->id; ?>"><?php echo $value->project_name; ?></option>
				     @endforeach
				</select>	
		    </div>
		</div>		
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<textarea class="form-control summernote" name="quotation_description" rows="20">{{ old('quotation_description') }}</textarea>
		...
		<div class="form-group">
		    ...
		    <div class="col-md-4">
			<textarea class="form-control summernote" name="quotation_remark" rows="10">{{ old('quotation_remark') }}</textarea>
